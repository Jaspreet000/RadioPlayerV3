...
async def main():
    async with bot:
        ...
        try:
            await USER.join_chat("armyblinkchatroom")
...
bot.run(main())
bot.start()
print("\n\nRadio Player Bot Started, Join @armyblinkchatroom!")
bot.send(
    SetBotCommands(
...
async def restart(_, message: Message):
    ...
    try:
        await k.edit("✅ **Restarted Successfully! \nJoin @sup_port_2 For Update!**")
        await k.reply_to_message.delete()
    except:
        pass

idle()
print("\n\nRadio Player Bot Stopped, Join @sup_port_2!")
bot.stop()
